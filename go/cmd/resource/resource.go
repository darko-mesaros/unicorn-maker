...
const APIEndpoint = "https://crudcrud.com/api/3b9f6c4dc3384af18b4cb92af1f1c10e/unicorns"
...
type Unicorn struct {
	...
	// Superpower is the what makes this unicorn cool
	Superpower string `json:"superpower,omitempty"`
	// What is the size of this unicorns family?
...
func validateInput(req handler.Request, model *Model) error {
	...
	if model.Superpower == nil {
		return errors.New("Superpower required")
	}
	return nil
}
...
func marshal(resource *Model) ([]byte, error) {
	...
	if resource.Superpower != nil {
		u.Superpower = aws.StringValue(resource.Superpower)
	}
	if resource.Family != nil {
		u.Family = aws.StringValue(resource.Family)
	}
...
func unmarshal(unicorn *Unicorn) *Model {
	m := Model{
		...
		Superpower: aws.String(unicorn.Superpower),
		Family: aws.String(unicorn.Family),
	}
	return &m
}
